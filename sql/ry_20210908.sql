...
values ('3', '系统工具', '0', '3', 'tool', null, '', 1, 0, 'M', '0', '0', '', 'tool', 'admin', sysdate(), '', null,
        '系统工具目录');
insert into sys_menu
values ('5', '资助申请', '0', '5', 'application', null, '', 1, 0, 'M', '0', '0', '', 'application', 'admin', sysdate(), '',
        null, '资助申请目录');
insert into sys_menu
values ('6', '我的筹款', '0', '6', 'myApplication', null, '', 1, 0, 'M', '0', '0', '', 'myApplication', 'admin', sysdate(),
        '', null, '我的资助申请目录');
insert into sys_menu
values ('4', '求助信息', '0', '4', 'helpinfo', null, '', 1, 0, 'M', '0', '0', '', 'helpinfo', 'admin', sysdate(), '', null,
        '求助信息目录');
insert into sys_menu
values ('7', '我的资助', '0', '7', 'myHelp', null, '', 1, 0, 'M', '0', '0', '', 'myHelp', 'admin', sysdate(), '', null,
        '我的资助目录');
...
insert into sys_menu
values ('117', '信息填写', '5', '1', 'applicationInfo', 'application/applicationInfo/index', '', 1, 0, 'C', '0', '0',
        'application:applicationInfo:list', 'applicationInfo', 'admin', sysdate(), '', null, '信息填写菜单');
insert into sys_menu
values ('118', '基本信息', '6', '1', 'myInfo', 'myApplication/myInfo/index', '', 1, 0, 'C', '0', '0',
        'myApplication:myInfo:list', 'myInfo', 'admin', sysdate(), '', null, '基本信息菜单');
insert into sys_menu
values ('119', '资助提现', '6', '2', 'withdrawalRecord', 'myApplication/withdrawalRecord/index', '', 1, 0, 'C', '0', '0',
        'myApplication:withdrawalRecord:list', 'withdrawalRecord', 'admin', sysdate(), '', null, '提现记录菜单');
insert into sys_menu
values ('120', '支出明细', '6', '3', 'detail', 'myApplication/detail/index', '', 1, 0, 'C', '0', '0',
        'myApplication:detail:list', 'detail', 'admin', sysdate(), '', null, '支出明细菜单');
insert into sys_menu
values ('121', '信息公示', '4', '1', 'information', 'helpinfo/information/index', '', 1, 0, 'C', '0', '0',
        'helpinfo:information:list', 'information', 'admin', sysdate(), '', null, '公示平台菜单');

insert into sys_menu
values ('122', '资助记录', '7', '1', 'helpRecord', 'myHelp/helpRecord/index', '', 1, 0, 'C', '0', '0',
        'myHelp:helpRecord:list', 'helpRecord', 'admin', sysdate(), '', null, '资助记录菜单');
