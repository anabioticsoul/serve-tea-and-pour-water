package com.ruoyi.web.crypto.encryption;
...
//    private static final String TARGET = "target";
    ...
    public static Map<String, String> encrypt(User user) {
        ...
        //加密字段
        List<String> schema = Arrays.asList(NAME, PHONE, ID_CARD, LOCATION, APPLICATION_TITLE, USER_INFO,
...
//            e.printStackTrace();
        ...
        certificateDataInput.put(PHONE, TransformUtils.transformStringToInt(user.getPhone()));
